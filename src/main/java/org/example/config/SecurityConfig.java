...
public class SecurityConfig {
    ...
    protected SecurityFilterChain SecurityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers(HttpMethod.GET, "/api/albums/**").hasAnyRole("ALBUMS_VIEWER", "ALBUMS_EDITOR", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/users/**").hasAnyRole("USERS_VIEWER", "USERS_EDITOR", "ADMIN")
